# Available .SHOW One-Word Domains (30,288)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-30%2C288%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **30,288 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 30,288 domains · **Median ask:** $17.40 · **High-demand under $2,500:** 2
...
| outdoors.show   | premium   | $242      | $242          | medium         | low    | 8      | namesilo                                                |
...
| automotive.show | premium   | $520      | $520          | medium         | low    | 10     | namecheap                                               |
...
| fan.show        | resell    | —         | —             | medium         | low    | 3      | DNSPod, Inc.                                            |
| coy.show        | available | $18.99    | $44.49        | low            | low    | 3      | namesilo                                                |
| kid.show        | resell    | —         | —             | high           | low    | 3      | Alibaba Cloud Computing Ltd. d/b/a HiChina (www.net.cn) |
| don.show        | available | $17.99    | —             | high           | low    | 3      | name.com                                                |
| kit.show        | resell    | —         | —             | medium         | low    | 3      | DNSPod, Inc.                                            |
| dry.show        | available | $17.99    | $56.99        | high           | low    | 3      | name.com                                                |
| new.show        | resell    | —         | —             | high           | medium | 3      | GoDaddy.com, LLC                                        |
| flu.show        | available | $17.99    | —             | medium         | low    | 3      | name.com                                                |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 30,288 live domains                        |
...
> Unique Domains. *Available .SHOW One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
