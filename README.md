# Available .SHOW One-Word Domains (28,617)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-28%2C617%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **28,617 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 28,617 domains · **Median ask:** $17.35 · **High-demand under $2,500:** 2
...
| fan.show        | resell    | —         | —             | high           | low    | 3      | DNSPod, Inc.                                            |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 28,617 live domains                        |
...
> Unique Domains. *Available .SHOW One-Word Domains*. Version 2026-09-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
